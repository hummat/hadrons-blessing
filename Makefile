...
.PHONY: require-source-root test resolve audit index-build index-check edges-build effects-build breeds-build check
...
check: require-source-root edges-build effects-build breeds-build
